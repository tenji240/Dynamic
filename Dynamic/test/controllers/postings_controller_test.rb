...
class PostingsControllerTest < ActionController::TestCase
  ...
  test "should create posting" do
    assert_difference('Posting.count') do
      post :create, posting: { description: @posting.description, experience: @posting.experience, postition: @posting.postition, skills: @posting.skills }
    end
  ...
  test "should update posting" do
    patch :update, id: @posting, posting: { description: @posting.description, experience: @posting.experience, postition: @posting.postition, skills: @posting.skills }
    assert_redirected_to posting_path(assigns(:posting))
  end
